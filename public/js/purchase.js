$(document).ready(function() {
    ...
    $(document).on('change', '.purchase_unit_cost_without_discount', function() {
        ...
        var discount_percent2= __read_number(row.find('input.inline_discounts_2'), true);
        var discount_percent3= __read_number(row.find('input.inline_discounts_3'), true);
        var discount_percent4= __read_number(row.find('input.inline_discounts_4'), true);
        var discount_percent5= __read_number(row.find('input.inline_discounts_5'), true);
        //  var discount_percent2 = __read_number(row.find('input.inline_discounts_2'), true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);

        //Calculations.
        var d1 = parseFloat(purchase_before_discount) -
            __calculate_amount('percentage', discount_percent, purchase_before_discount);
        var d2 = parseFloat(d1) -
            __calculate_amount('percentage', discount_percent2, d1);
        var d3 = parseFloat(d2) -
            __calculate_amount('percentage', discount_percent3, d2);
        var d4 = parseFloat(d3) -
            __calculate_amount('percentage', discount_percent4, d3);
        
        var purchase_before_tax =
            parseFloat(d4) -
            __calculate_amount('percentage', discount_percent5, d4);
        ...
        __write_number(row.find('input.purchase_unit_cost'), 99999, true);
    ...
    $(document).on('change', '.inline_discounts', function() {
        ...
        var purchase_before_tax =
            parseFloat(purchase_before_discount) -
            __calculate_amount('percentage', discount_percent, purchase_before_discount) -
            __calculate_amount('percentage', discount_percent2, purchase_before_discount) -
            __calculate_amount('percentage', discount_percent3, purchase_before_discount) -
            __calculate_amount('percentage', discount_percent4, purchase_before_discount) -
            __calculate_amount('percentage', discount_percent5, purchase_before_discount) ;
        // window.alert(purchase_before_tax);
        
        var d1rp = __calculate_amount('percentage', discount_percent, purchase_before_discount);
        __write_number(row.find('input.inline_discount_rp'), d1rp, true);
    ...
    // Disc2
    $(document).on('change', '.inline_discounts_2', function() {
        var row = $(this).closest('tr');

        var discount_percent = __read_number(row.find('input.inline_discounts'), true);
        var discount_percent2= __read_number($(this), true);
        var discount_percent3= __read_number(row.find('input.inline_discounts_3'), true);
        var discount_percent4= __read_number(row.find('input.inline_discounts_4'), true);
        var discount_percent5= __read_number(row.find('input.inline_discounts_5'), true);
        ...
        var d2rp = __calculate_amount('percentage', discount_percent2, purchase_before_discount);
        __write_number(row.find('input.inline_discount_rp_2'), d2rp, true);
    ...
    // Disc3
    $(document).on('change', '.inline_discounts_3', function() {
        var row = $(this).closest('tr');

        var discount_percent = __read_number(row.find('input.inline_discounts'), true);
        var discount_percent2= __read_number(row.find('input.inline_discounts_2'), true);
        var discount_percent3= __read_number($(this), true);
        var discount_percent4= __read_number(row.find('input.inline_discounts_4'), true);
        var discount_percent5= __read_number(row.find('input.inline_discounts_5'), true);
        //  var discount_percent2 = __read_number(row.find('input.inline_discounts_2'), true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        ...
        var d3rp = __calculate_amount('percentage', discount_percent3, purchase_before_discount);
        __write_number(row.find('input.inline_discount_rp_3'), d3rp, true);
    ...
    // Disc4
    $(document).on('change', '.inline_discounts_4', function() {
        var row = $(this).closest('tr');

        var discount_percent = __read_number(row.find('input.inline_discounts'), true);
        var discount_percent2= __read_number(row.find('input.inline_discounts_2'), true);
        var discount_percent3= __read_number(row.find('input.inline_discounts_3'), true);
        var discount_percent4= __read_number($(this), true);
        var discount_percent5= __read_number(row.find('input.inline_discounts_5'), true);
        //  var discount_percent2 = __read_number(row.find('input.inline_discounts_2'), true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        ...
        var d4rp = __calculate_amount('percentage', discount_percent4, purchase_before_discount);
        __write_number(row.find('input.inline_discount_rp_4'), d4rp, true);
    ...
    // Disc5
    $(document).on('change', '.inline_discounts_5', function() {
        var row = $(this).closest('tr');
        ...
        var discount_percent3= __read_number(row.find('input.inline_discounts_3'), true);
        var discount_percent4= __read_number(row.find('input.inline_discounts_4'), true);
        var discount_percent5= __read_number($(this), true);
        //  var discount_percent2 = __read_number(row.find('input.inline_discounts_2'), true);
        var quantity = __read_number(row.find('input.purchase_quantity'), true);
        ...
        var purchase_before_tax =
            ...
            __calculate_amount('percentage', discount_percent5, purchase_before_discount) ;
        // window.alert(purchase_before_tax);
        var d5rp = __calculate_amount('percentage', discount_percent5, purchase_before_discount);
        __write_number(row.find('input.inline_discount_rp_5'), d5rp, true);
        __write_number(row.find('input.purchase_unit_cost'), purchase_before_tax, true);
    ...
    // Disc Rupiah 1
    $(document).on('change', '.inline_discount_rp', function() {
        var row = $(this).closest('tr');

        var discount_rp   = __read_number($(this), true);
        
        var discount_rp_2 = __read_number(row.find('input.inline_discount_rp_2'), true);
        var discount_rp_3 = __read_number(row.find('input.inline_discount_rp_3'), true);
        var discount_rp_4 = __read_number(row.find('input.inline_discount_rp_4'), true);
        var discount_rp_5 = __read_number(row.find('input.inline_discount_rp_5'), true);
        ...
        var purchase_before_tax =
            parseFloat(purchase_before_discount) - 
            parseFloat(discount_rp) - 
            parseFloat(discount_rp_2) -
            parseFloat(discount_rp_3) -
            parseFloat(discount_rp_4) -
            parseFloat(discount_rp_5);
            
        // window.alert(purchase_before_tax);
        
        var d1persen = (discount_rp/purchase_before_discount)*100;
        __write_number(row.find('input.inline_discounts'), d1persen, true);
    ...
    // Disc Rupiah 2
    $(document).on('change', '.inline_discount_rp_2', function() {
        var row = $(this).closest('tr');

        var discount_rp   = __read_number(row.find('input.inline_discount_rp'), true);
        
        var discount_rp_2 = __read_number($(this), true);
        var discount_rp_3 = __read_number(row.find('input.inline_discount_rp_3'), true);
        var discount_rp_4 = __read_number(row.find('input.inline_discount_rp_4'), true);
        var discount_rp_5 = __read_number(row.find('input.inline_discount_rp_5'), true);
        ...
        var d2persen = (discount_rp_2/purchase_before_discount)*100;
        __write_number(row.find('input.inline_discounts_2'), d2persen, true);
    ...
    // Disc Rupiah 3
    $(document).on('change', '.inline_discount_rp_3', function() {
        var row = $(this).closest('tr');

        var discount_rp   = __read_number(row.find('input.inline_discount_rp'), true);
        
        var discount_rp_2 = __read_number(row.find('input.inline_discount_rp_2'), true);
        var discount_rp_3 = __read_number($(this), true);
        var discount_rp_4 = __read_number(row.find('input.inline_discount_rp_4'), true);
        var discount_rp_5 = __read_number(row.find('input.inline_discount_rp_5'), true);
        ...
        var d3persen = (discount_rp_3/purchase_before_discount)*100;
        __write_number(row.find('input.inline_discounts_3'), d3persen, true);
    ...
    // Disc Rupiah 4
    $(document).on('change', '.inline_discount_rp_4', function() {
        var row = $(this).closest('tr');
        ...
        var discount_rp_2 = __read_number(row.find('input.inline_discount_rp_2'), true);
        var discount_rp_3 = __read_number(row.find('input.inline_discount_rp_3'), true);
        var discount_rp_4 = __read_number($(this), true);
        var discount_rp_5 = __read_number(row.find('input.inline_discount_rp_5'), true);
        ...
        var d4persen = (discount_rp_4/purchase_before_discount)*100;
        __write_number(row.find('input.inline_discounts_4'), d4persen, true);
    ...
    // Disc Rupiah 5
    $(document).on('change', '.inline_discount_rp_5', function() {
        var row = $(this).closest('tr');
        ...
        var discount_rp_3 = __read_number(row.find('input.inline_discount_rp_3'), true);
        var discount_rp_4 = __read_number(row.find('input.inline_discount_rp_4'), true);
        var discount_rp_5 = __read_number($(this), true);
        ...
        var d5persen = (discount_rp_5/purchase_before_discount)*100;
        __write_number(row.find('input.inline_discounts_5'), d5persen, true);
...
function append_purchase_lines(data, row_count) {
    $(data)
...
function update_purchase_entry_row_values(row) {
    if (typeof row != 'undefined') {
        ...
        // var discount_percent = __read_number(row.find('.discount_percent'), true);
        // var discount_percent_2 = __read_number(row.find('.discount_percent_2'), true);
        // var discount_percent_3 = __read_number(row.find('.discount_percent_3'), true);
        // var discount_percent_4 = __read_number(row.find('.discount_percent_4'), true);
        // var discount_percent_5 = __read_number(row.find('.discount_percent_5'), true);
        
      
        
        // var discount_rp = __read_number(row.find('.discount_rp'), true);
        // var discount_rp_2 = __read_number(row.find('.discount_rp_2'), true);
        // var discount_rp_3 = __read_number(row.find('.discount_rp_3'), true);
        // var discount_rp_4 = __read_number(row.find('.discount_rp_4'), true);
        // var discount_rp_5 = __read_number(row.find('.discount_rp_5'), true);
        ...
        // __write_number(row.find('.discount_percent'), discount_percent, true);
        // __write_number(row.find('.discount_percent_2'), discount_percent_2, true);
        // __write_number(row.find('.discount_percent_3'), discount_percent_3, true);
        // __write_number(row.find('.discount_percent_4'), discount_percent_4, true);
        // __write_number(row.find('.discount_percent_5'), discount_percent_5, true);
        
        // __write_number(row.find('.discount_rp'), discount_rp, true);
        // __write_number(row.find('.discount_rp_2'), discount_rp_2, true);
        // __write_number(row.find('.discount_rp_3'), discount_rp_3, true);
        // __write_number(row.find('.discount_rp_4'), discount_rp_4, true);
        // __write_number(row.find('.discount_rp_5'), discount_rp_5, true);
