...
class ProductUtil extends Util
{
    ...
    public function createOrUpdatePurchaseLines($transaction, $input_data, $currency_details, $enable_product_editing, $before_status = null)
    {
        ...
        foreach ($input_data as $data) {
            ...
            $new_quantity_bagi_f = $this->num_f($new_quantity_bagi);
            $old_qty = 0;
            ...
            $purchase_line->bagi = $this->num_uf($data['quantitybagi'], $currency_details);
            ...
            $purchase_line->discount_percent_2 = $this->num_uf($data['discount_percent_2'], $currency_details);
            
            $purchase_line->discount_percent_3 = $this->num_uf($data['discount_percent_3'], $currency_details);
            $purchase_line->discount_percent_4 = $this->num_uf($data['discount_percent_4'], $currency_details);
            $purchase_line->discount_percent_5 = $this->num_uf($data['discount_percent_5'], $currency_details);
            
            // Disc Rupiah
            if (isset($data['purchase_line_id'])) {
            
            $purchase_line->discount_rp = $this->num_uf($data['discount_rp'], $currency_details);
            $purchase_line->discount_rp_2 = $this->num_uf($data['discount_rp_2'], $currency_details);
            
            $purchase_line->discount_rp_3 = $this->num_uf($data['discount_rp_3'], $currency_details);
            $purchase_line->discount_rp_4 = $this->num_uf($data['discount_rp_4'], $currency_details);
            $purchase_line->discount_rp_5 = $this->num_uf($data['discount_rp_5'], $currency_details);
            }
            ...
            if ($enable_product_editing == 1) {
                ...
                $variation_data['pp_without_discount'] = ($this->num_uf($data['purchase_price'], $currency_details)*$exchange_rate) / $multiplier;
