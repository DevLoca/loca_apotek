...
<div class="table-responsive">
    ...
    id="purchase_entry_table">
        <thead>
							<tr>
								...
								<th rowspan="2" class="@if(!session('business.enable_editing_product_from_purchase')) hide @endif">
									Profit
								</th>
    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr @if(!empty($purchase_line->purchase_order_line) && !empty($common_settings['enable_purchase_order'])) data-purchase_order_id="{{$purchase_line->purchase_order_line->transaction_id}}" @endif>
            ...
            <td>
                {!! Form::text('purchases[' . $loop->index . '][discount_percent]', number_format($purchase_line->discount_percent, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts input_number', 'required']); !!} 
                {!! Form::text('purchases[' . $loop->index . '][discount_percent_2]', number_format($purchase_line->discount_percent_2, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_2 input_number', 'required']); !!} 
                {!! Form::text('purchases[' . $loop->index . '][discount_percent_3]', number_format($purchase_line->discount_percent_3, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_3 input_number', 'required']); !!} 
                {!! Form::text('purchases[' . $loop->index . '][discount_percent_4]', number_format($purchase_line->discount_percent_4, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_4 input_number', 'required']); !!}
                {!! Form::text('purchases[' . $loop->index . '][discount_percent_5]', number_format($purchase_line->discount_percent_5, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_5 input_number', 'required']); !!} 
            </td>
            <!--Disc Rupiah-->
            <td>
                {!! Form::text('purchases[' . $loop->index . '][discount_rp]', number_format($purchase_line->discount_rp, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp input_number', 'required']); !!} 
                {!! Form::text('purchases[' . $loop->index . '][discount_rp_2]', number_format($purchase_line->discount_rp_2, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_2 input_number', 'required']); !!} 
                {!! Form::text('purchases[' . $loop->index . '][discount_rp_3]', number_format($purchase_line->discount_rp_3, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_3 input_number', 'required']); !!} 
                {!! Form::text('purchases[' . $loop->index . '][discount_rp_4]', number_format($purchase_line->discount_rp_4, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_4 input_number', 'required']); !!}
                {!! Form::text('purchases[' . $loop->index . '][discount_rp_5]', number_format($purchase_line->discount_rp_5, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_5 input_number', 'required']); !!}    
            </td>
            <!--HPP-->
            <td>
                {!! Form::text('purchases[' . $loop->index . '][purchase_price]', number_format($purchase_line->purchase_price, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost input_number', 'required']); !!}
                {!! Form::text('purchases[' . $loop->index . '][purchase_price]', number_format($purchase_line->purchase_price, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost input_number', 'required']); !!}
            </td>
            <!--END HPP-->
            ...
            <td>
                @if(session('business.enable_editing_product_from_purchase'))
                    {!! Form::label('purchases[' . $loop->index . '][default_sell_price]', number_format($sp, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm input_number default_sell_price', 'required']); !!}
                @else
