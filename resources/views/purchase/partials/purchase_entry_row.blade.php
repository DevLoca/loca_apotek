    ...
    <tr @if(!empty($purchase_order_line)) data-purchase_order_id="{{$purchase_order_line->transaction_id}}" @endif>
        ...
        <td>
            @php
                ...
                $discount_percent_2 = !empty($purchase_order_line) ? $purchase_order_line->$discount_percent_2 : 0;
                
                $discount_percent_3 = !empty($purchase_order_line) ? $purchase_order_line->$discount_percent_3 : 0;
            
                $discount_percent_4 = !empty($purchase_order_line) ? $purchase_order_line->$discount_percent_4 : 0;
                
                $discount_percent_5 = !empty($purchase_order_line) ? $purchase_order_line->$discount_percent_5 : 0;
                
                $discount_rp = !empty($purchase_order_line) ? $purchase_order_line->$discount_rp : 0;
                $discount_rp_2 = !empty($purchase_order_line) ? $purchase_order_line->$discount_rp_2 : 0;
                $discount_rp_3 = !empty($purchase_order_line) ? $purchase_order_line->$discount_rp_3 : 0;
                $discount_rp_4 = !empty($purchase_order_line) ? $purchase_order_line->$discount_rp_4 : 0;
                $discount_rp_5 = !empty($purchase_order_line) ? $purchase_order_line->$discount_rp_5 : 0;
            ...
            {!! Form::label('purchases[' . $row_count . '][pp_without_discount]',
            number_format($pp_without_discount, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost_without_discount input_number', 'required']); !!}
        </td>
        <!--Disc 1-->
        <td>
            ...
            {!! Form::text('purchases[' . $row_count . '][discount_percent_2]', number_format($discount_percent_2, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_2 input_number', 'required']); !!}
            {!! Form::text('purchases[' . $row_count . '][discount_percent_3]', number_format($discount_percent_3, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_3 input_number', 'required']); !!}
            {!! Form::text('purchases[' . $row_count . '][discount_percent_4]', number_format($discount_percent_4, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_4 input_number', 'required']); !!}
            {!! Form::text('purchases[' . $row_count . '][discount_percent_5]', number_format($discount_percent_5, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discounts_5 input_number', 'required']); !!}
        </td>
        <!--Disc 2-->
        ...
        <td>
            ...
            {!! Form::text('purchases[' . $row_count . '][discount_rp]', number_format($discount_rp, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp input_number', 'required']); !!}
            {!! Form::text('purchases[' . $row_count . '][discount_rp_2]', number_format($discount_rp_2, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_2 input_number', 'required']); !!}
             {!! Form::text('purchases[' . $row_count . '][discount_rp_3]', number_format($discount_rp_3, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_3 input_number', 'required']); !!}
             {!! Form::text('purchases[' . $row_count . '][discount_rp_4]', number_format($discount_rp_4, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_4 input_number', 'required']); !!}
             {!! Form::text('purchases[' . $row_count . '][discount_rp_5]', number_format($discount_rp_5, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm inline_discount_rp_5 input_number', 'required']); !!}
        ...
        <td>
            @if(session('business.enable_editing_product_from_purchase'))
                {!! Form::label('purchases[' . $row_count . '][default_sell_price]', number_format($variation->sell_price_inc_tax, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm input_number default_sell_price', 'required']); !!}
            @else
