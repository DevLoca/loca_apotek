...
<div class="modal-body">
        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="text-right">Disc1</th>
              <th class="text-right">Disc2</th>
              <th class="text-right">Disc3</th>
              <th class="text-right">Disc4</th>
              <th class="text-right">Disc5</th>
              <th class="no-print text-right">Hpp Sebelum Tax</th>
              <th class="no-print text-right">Subtotal</th>
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td class="text-right"><span class="display_currency">{{ $purchase_line->discount_percent_2}}</span> %</td>
              <td class="text-right"><span class="display_currency">{{ $purchase_line->discount_percent_3}}</span> %</td>
              <td class="text-right"><span class="display_currency">{{ $purchase_line->discount_percent_4}}</span> %</td>
              <td class="text-right"><span class="display_currency">{{ $purchase_line->discount_percent_5}}</span> %</td>
  ...
  <br>
  <div class="row">
    <div class="col-md-6 col-sm-12 col-xs-12 @if($purchase->type == 'purchase_order') col-md-offset-6 @endif"></div>
